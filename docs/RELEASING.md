...
A per-release record lives in [`docs/RELEASE-LOG.md`](RELEASE-LOG.md): a table row for the verification trail and a bulleted "What shipped" section listing each change.
