...
contains "row opens with the change bullets" "$row" "| 2026-09-02 | - first<br>- second<br>"
...
contains "row joins the bullets with <br>" "$row" "- first<br>- second<br>- All four jobs"
