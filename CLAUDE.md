...
**Core Value:** **The black-user / grey-AI in-place augmented-notes UX, running fully local on macOS without a meeting bot.** Every other feature exists to make this hero experience possible — if augmented notes don't feel indistinguishable from Granola's, the product fails.
